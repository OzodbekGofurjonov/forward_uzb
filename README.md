...
### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/OzodbekGofurjonov/forward_uzb)
...
Deploy in your vps
```sh
git clone https://github.com/hagtic/Frwdittn
cd Frwdittn
...
* `SESSION` Enter Pyrogram session string [String Generator](https://replit.com/@hagtic/PyroSessionString)
